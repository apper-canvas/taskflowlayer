      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="flex gap-3">
          ...
          <Button
            ...
            className="h-12 px-4 text-slate-500 hover:text-slate-700 hover:bg-slate-50"
          >
            <ApperIcon 
              name={showDescription ? "ChevronUp" : "FileText"} 
              size={20} 
            />
          </Button>
          <Button
            ...
            >
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={3}
                  className="text-sm placeholder:text-slate-400 border-slate-200 focus:border-primary focus:ring-primary/20"
                />
              </div>
            </motion.div>
          )}
